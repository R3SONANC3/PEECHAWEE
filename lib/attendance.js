...
// Every sheet title attendance.js owns or has owned — for lib/teams.js to
// exclude from "these are team sheets" regardless of migration state.
export const NON_TEAM_ATTENDANCE_SHEET_NAMES = [...Object.values(WAR_SHEETS), LEGACY_ATTENDANCE_SHEET_NAME];
...
// Locked per war: syncNamesFromRoster can itself clear+rewrite the whole
