...
import { NON_TEAM_ATTENDANCE_SHEET_NAMES } from './attendance';
...
export async function listTeamSheetTitles() {
  ...
  return sorted
    .filter((t) => t.title !== rosterTitle && !NON_TEAM_ATTENDANCE_SHEET_NAMES.includes(t.title) && t.title !== GEAR_SHEET_NAME)
    .map((t) => t.title);
}
